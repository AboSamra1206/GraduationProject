              ...
              <div className="relative overflow-hidden rounded-xl bg-slate-800/50 backdrop-blur-sm border border-blue-500/20 p-6 hover:border-blue-500/50 transition-all duration-300">
                ...
                <div className="relative z-10">
                  ...
                  <motion.a
                    href={download.url}
                    download
                    className="w-full flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-lg font-medium transition-all duration-300 cursor-pointer"
